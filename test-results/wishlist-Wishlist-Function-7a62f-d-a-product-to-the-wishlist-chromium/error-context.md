...
- Name: wishlist.spec.js >> Wishlist Functionality >> can add a product to the wishlist
- Location: tests/wishlist.spec.js:9:7
...
Locator: locator('.card-wrapper').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.card-wrapper').first()
